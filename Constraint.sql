...
ALTER TABLE tb_Profession
	ADD CONSTRAINT PK_Profession_IDProfession PRIMARY KEY(IDProfession),
		CONSTRAINT KF_Profession_InstShortName FOREIGN KEY(InstShortName) REFERENCES tb_Institute(ShortNameInst),
		CONSTRAINT UQ_Profession_CodeProfession UNIQUE(CodeProfession),
		CONSTRAINT UQ_Profession_NameProfession UNIQUE(NameProfession),
...
ALTER TABLE tb_ExamRecord
	ADD CONSTRAINT PK_ExamRecord_IDExamRecord PRIMARY KEY(IDExamRecord),
		...
		CONSTRAINT DF_ExamRecord_ExamDate DEFAULT(GETDATE())
...
ALTER TABLE tb_Student
	ADD CONSTRAINT PK_Student_IDStudent PRIMARY KEY(IDStudent),
		...
		CONSTRAINT UQ_Student_Account UNIQUE(AccountID),
		CONSTRAINT FK_Student_InstShortName FOREIGN KEY(InstShortName) REFERENCES tb_Institute(ShortNameInst),
		CONSTRAINT FK_Student_ProfessionCode FOREIGN KEY(ProfessionCode) REFERENCES tb_Profession(CodeProfession),
