...
ALTER TABLE tb_Groups
	ADD CONSTRAINT PK_Groups_GroupID PRIMARY KEY(GroupID),
		CONSTRAINT UQ_Groups_GroupName UNIQUE(GroupName),
		CONSTRAINT FK_Groups_ProfessionCode FOREIGN KEY(ProfessionCode) REFERENCES tb_Profession(ProfessionCode),
...
ALTER TABLE tb_Student
	ADD CONSTRAINT PK_Student_StudentID PRIMARY KEY(StudentID),
		...
		CONSTRAINT FK_Student_GroupName FOREIGN KEY(GroupName) REFERENCES tb_Groups(GroupName)
